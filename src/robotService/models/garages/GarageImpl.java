...
public class GarageImpl implements Garage {
    ...
    public void manufacture(Robot robot) {
        ...
        if (this.robots.containsKey(robot.getName())){
            throw new IllegalArgumentException(String.format("Robot %s already exist",robot.getName()));
        }
    ...
    public void sell(String robotName, String ownerName) {
        if (!this.robots.containsKey(robotName)){
            throw new IllegalArgumentException(String.format("Robot %s does not exist",robotName));
        }
